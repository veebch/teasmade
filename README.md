...
The motivation for doing this is a simple proof-of-concept for using a ring-fenced online resource to trigger device-automation without sacrificing vast amounts of privacy. 
